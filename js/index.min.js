var cabecalho  = new Vue({
  ...
  var linhaTempo = new Vue({
	...
	data: {
	  ages: [
		  { type:'hist', class:'content', hasText:true, title:'2021', pos:'container right', sTitle1:'Senior IT Analyst', sTitle2:'CRECI-SP', txt:'Working in development and project of systems of the council.', techs:'.NET, EF, nodeJs, PHP, C#, ASP, PHP' },
