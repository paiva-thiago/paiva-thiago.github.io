var cabecalho  = new Vue({
  ...
  var linhaTempo = new Vue({
	...
	data: {
	  ages: [
		  { type:'hist', class:'content', hasText:true, title:'2022', pos:'container right', sTitle1:'Coder (Development Teacher)', sTitle2:'Let\'s Code', txt:'Teaching Java-related courses.', techs:'Java' },
		  { type:'hist', class:'content', hasText:true, title:'01/2022-02/2022', pos:'container left', sTitle1:'Content Producer', sTitle2:'Trybe', txt:'Development of material for java spring framework course', techs:'Java, Spring' },
		  { type:'hist', class:'content', hasText:true, title:'2021', pos:'container right', sTitle1:'Software Developer', sTitle2:'Integer', txt:'Working in development and maintenance of systems related to Portugal\'s Social Security.', techs:'Java, Swing, EJB, Oracle' },
		  { type:'place', class:'sign place', hasText:false, title:'Lisboa/Remote'},
		  { type:'hist', class:'content', hasText:true, title:'03/2021-09-2021', pos:'container left', sTitle1:'Senior IT Analyst', sTitle2:'CRECI-SP', txt:'Working in development and project of systems of the council.', techs:'.NET, EF, nodeJs, PHP, C#, ASP, PHP' },
		  { type:'place', class:'sign place', hasText:false, title:'São Paulo/Remote'},
		  { type:'hist', class:'content', hasText:true, title:'2018-2021', pos:'container right', sTitle1:'Senior Systems Analyst', sTitle2:'Prefeitura Municipal de São Bernardo do Campo/SP', txt:'Working in development of tax systems of the city hall.', techs:'Struts1, EJB1, Javascript, HTML, CSS.' },
